...
| `isaac_s4_bounded` | [`s4_gate.json`](../../evidence/smolvla_s4_bounded5_20260724T203700Z/s4_gate.json) | interface + task funnel | interface 5/5；lift 0/5 → Hold；`claims_*=false` |

组合产物：[`evidence/smolvla_v3_eval_framework_20260724/smolvla_v3_eval_framework_bundle.json`](../../evidence/smolvla_v3_eval_framework_20260724/smolvla_v3_eval_framework_bundle.json)
