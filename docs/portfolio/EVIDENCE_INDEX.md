...
| `docs/portfolio/readme_three_repo_overview.svg` | 三仓（canonical 在中游） | 主线/design | 2026-08-03 三仓 README 中性总览图 | 手工 SVG，事实源为三仓根 README、AGENTS 与 BOUNDARY_FREEZE | 上游执行、中游交付、下游验证的职责与六层证据边界 | 任务成功、Sim2Real、实体硬件验收、功能安全认证 | keep |
