#!/usr/bin/env python3
"""Thin CLI for SmolVLA S3 control-plane.

Library implementation: ``training.smolvla_s3.control_plane``.
...
from training.smolvla_s3 import control_plane as _lib  # noqa: E402
