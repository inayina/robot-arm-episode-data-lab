"""SmolVLA S3 paired open-loop evaluation library.

Thin CLI: ``training/scripts/run_smolvla_s3_open_loop.py``.

Original purpose: SmolVLA S3 paired open-loop: base (S2 protocol) vs LoRA (native abs-EEF).
